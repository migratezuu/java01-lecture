package com.greedy.section04.complition;
...
public class Application1 {
		...
		public static void main(String[] args) {
			...
			System.out.println("ch1이 ch1보다 크거나 같은지 비교 : "  + (ch1 >= ch2));
...
//			System.out.println("bool1과 bool2가 같지 않은지 비교 : " + (bool1 > bool2));
			...
			System.out.println("str1과 str2가 같은지 비교 : " + (str1 == str2)); //스택영역 비교
			System.out.println("str1과 str2가 같지 않은지 비교 : " + (str1 != str2));
//			System.out.println("str1이 str2보다 큰 지 비교 : " + (str1 > str2)); //문자열은 단순 연산자로 대소비교가 불가
