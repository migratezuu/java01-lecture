...
public class Application6 {
	...
	public static void main(String[] args) {
		...
		/*메소드 리턴값 테스트
		 * 메소드는 항상 마지막에 return 명형어가 존재한다.
		 * return은 자신을 호출한 구문으로 복귀하는 것을 의미한다.
		 * 복귀할 떼 그냥 복귀를 할 수도 있지만, 값을 가지고 복귀할 수도 있다.
		 * 이 때 가지고 가는 값을 리턴값이라고 한다.
		 * 
		 * return값을 반환받기 위해서는 메소드 선언부에 리턴 타입을 명시해주어야 한다.
		 ...
		 * 또한 메소드 선언부에 선언한 리턴 타입과 반환값의 자료형은 반드시 일치해야한다.
		 * 리턴값은 1개만 반환 가능하다.
		 */
		
		Application6 app6 = new Application6();
		String returnText = app6.testMethod(); //호출구문
