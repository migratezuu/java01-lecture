...
public class D_switch {
	...
	public void testSimpleSwitchStatement() {
		 ...
		 * [switch문 표현식]
		 * switch(비교할변수) {
		 * 		case 비교값1 : 비교값1과 일치하지 않는 경우 실행할 구문; break;
		 * 		case 비교값2 : 비교값2와 일치하지 않는 경우 실행할 구문; break;
		...
		case '%' :
			...
			/* default문은 생략 가능하지만 생략하는 경우 이 위치에 주석으로 생략 이유를 달아주는 것이 좋다.*/
