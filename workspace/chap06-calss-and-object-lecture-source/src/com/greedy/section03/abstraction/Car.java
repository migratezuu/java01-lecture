...
public class Car {
	...
	private boolean isOn; // 시동이 걸려 있으면! => 위에 선언해야 아래 것들이 돼.. 시동은 걸려야 다 되니까여
	private int speed = 0; // 전역변수로 들어가야 시속 초기화가 안돼!

	public void startUp() { //메소드
		if(isOn) {
	...
	public void trunOff() {
		 if(isOn) {
			 ...
			 System.out.println("이미 시동이 꺼져있는 상태입니다. 시동상태를 확인하세요.");
		 }
	}
