...
public class ComputerDTO extends ProductDTO{
	...
	public ComputerDTO(String code, String brand, String name, int price,
			java.util.Date manufacturingDate,String cpu, int hdd, int ram, String operationSystem) {
	...
	public String getInformation() {
		...
		return super.getInformation() //this를 호출하면 재귀가 발생
				+ "ComputerDTO [cpu=" + cpu
				+ ", hdd = " + hdd
				+ ", ram = " + ram
