...
//	public InterProduct() {}
	...
	/* 상수 필드만을 가질 수 있기 때문에 모든 필드는 묵시적으로 public static final의 의미를 가짐*/
	public static final int MAX_NUM = 100;
	int MIN_NUM = 10; //public static fianl 을 자동을 붙여줌(생략) => 대신 반드시 값을 초기화 해주어야함

	
	/* 인터페이스는 구현부가 있는 non-static 메소드를 가질 수 있다.*/
//	public void nonStaticMethod() {}
	...
	/* default 키워드를 사용하면 non-static 메소드도 작성 가능하다. (JDK 1.8부터 추가된 기능)*/
