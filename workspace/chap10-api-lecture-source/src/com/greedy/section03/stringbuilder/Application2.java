...
public class Application2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(sb1.capacity()); //배열의 길이를 반환해줌.
		
		/* append() : 인자로 전달된 값을 문자열로 반환 후 기존 문자열의 마지막에 추가한다. 
		 * 기본 용량을 초과하는 경우 (기존용량 + 1) * 2를 헤서 용량을 확장시킨다. 
		 * */
		for(int i = 0; i <50; i++) {
			sb1.append(i);
		 ...
		 *  */
		System.out.println("delete() : " +sb2.delete(2, 5));  //2~4인덱스르 제거함
		...
		System.out.println("insert() : " + sb2.insert(sb2.length(), "jdgc"));
