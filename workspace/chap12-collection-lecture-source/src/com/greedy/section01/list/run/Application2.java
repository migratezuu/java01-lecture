...
public class Application2 {
	...
	public static void main(String[] args) {
		...
		List<BookDTO> bookList = new ArrayList<>();    //제네릭으로 고정
...
//		}
//		
//		bookList.forEach(System.out::println);  //람다 알필요없어
		...
		/* 익명클래스 {}를 만들어서 마치 Comparator 인터페이스를 상속받은 클래스를 작성하는 것과 같이 사용된다.*/
...
//		bookList.sort((BookDTO b1, BookDTO b2) -> b1.getPrice() >= b2.getPrice()? -1 : 1);
		...
		System.out.println("작가 순 내림순 정렬 ============");
		for(BookDTO book : bookList) {
			System.out.println(book);
		}
