...
public class D_CardLayout extends JFrame{
	...
	public D_CardLayout() {
		...
		card2.setBackground(new Color(50, 100, 50));
		...
		card1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if(e.getButton() == 1) {		//마우스 왼쪽 버튼은 1번
					card.next(card1.getParent());
				}
				if(e.getButton() == 3) { 
					card.next(card1.getParent());//마우스 오른쪽
		...
		card2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(e.getButton() == 3) { 
					card.next(card2.getParent());//마우스 오른쪽
		...
		card3.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(e.getButton() == 3) { 
					card.next(card3.getParent());//마우스 오른쪽
